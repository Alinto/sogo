...
* Red Hat Enterprise Linux (RHEL) Server 6 and 7
* Community ENTerprise Operating System (CentOS) 6 and 7
...
baseurl=https://<username>:<password>@packages.inverse.ca/SOGo/release/4/rhel/7/$basearch
gpgcheck=1
----
