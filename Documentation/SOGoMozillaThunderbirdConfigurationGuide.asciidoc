...
Mozilla Thunderbird versions 2, 3.1, 10 ESR (Extended Support Release),
17 ESR, 24, 31 and above are supported and it is recommended to use
...
When using Thunderbird, version 24, 31 or later, you can use the latest
version of Mozilla Lightning. Use the Add-ons manager of Thunderbird or
visit:
...
integration of Mozilla Thunderbird 2, 3.1, 10 ESR, 17 ESR, 24, 31 and
later with the SOGo groupware solution.
